...
const reportRoot = path.join(auditRoot, "pilot-dry-run-10");
const reportBooksRoot = path.join(reportRoot, "books");
const mainJsonPath = path.join(reportRoot, "pilot-dry-run-10.json");
const mainMarkdownPath = path.join(reportRoot, "pilot-dry-run-10.md");
...
const titleOverrides: Record<string, string> = {
  "a-story-of-the-stone-age": "A Story of the Stone Age",
  filmer: "Filmer",
  "the-magic-shop": "The Magic Shop",
  "the-man-who-could-work-miracles": "The Man Who Could Work Miracles",
  "the-inspector-french-s-greatest-case": "The Inspector French's Greatest Case",
  "the-remarkable-case-of-davidson-s-eyes": "The Remarkable Case of Davidson's Eyes",
  "the-truth-about-pyecraft": "The Truth About Pyecraft",
  "two-in-a-sack": "Two in a Sack",
};
...
> = {
  "deep-sea-plunderings": {
    label: "THROUGH FIRE AND WATER",
    startPhrase: "What a clumsy, barrel-bellied old hooker she is",
    convention: "story or titled-section headings after contents/illustration lists",
    likelySectionCount: 24,
    strategyNote:
      "the 24 contents-listed story headings beginning with THROUGH FIRE AND WATER; exclude prefatory note, contents, illustration list, and publisher ads",
    examples: [
  ...
  "five-little-peppers-at-school": {
    label: "I HARD TIMES FOR JOEL",
    startPhrase: "Come on, Pepper.",
    convention: "bare roman chapter-title headings",
    likelySectionCount: 25,
    strategyNote:
      "the 25 contents-listed roman chapter headings beginning with I HARD TIMES FOR JOEL; exclude title page, book list, contents, and illustrations",
    examples: [
  ...
  "the-amateur-cracksman": {
    ...
    convention: "story or titled-section headings after contents",
    likelySectionCount: 8,
    strategyNote:
      "the 8 contents-listed Raffles story headings beginning with THE IDES OF MARCH; exclude title page, dedication, and contents",
    examples: [
      "THE IDES OF MARCH",
      "A COSTUME PIECE",
  ...
  "the-time-machine": {
    ...
    convention: "standalone roman numeral sections with verified Chapter I override",
    likelySectionCount: 15,
    strategyNote:
      "the 15 roman numeral sections beginning with I. Introduction; exclude the leading contents list and Gutenberg wrapper",
    examples: ["I. Introduction", "II. The Machine", "III. The Time Traveller Returns"],
  },
  kidnapped: {
    label: "CHAPTER I: I SET OFF UPON MY JOURNEY TO THE HOUSE OF SHAWS",
    startPhrase: "I will begin the story of my adventures",
    convention: "chapter-based roman numerals with verified Chapter I override",
    likelySectionCount: 30,
    strategyNote:
      "the 30 numbered chapters beginning with CHAPTER I; exclude title page, credits, and contents/source wrapper",
    examples: [
  ...
  "oliver-twist": {
    ...
    startPhrase: "Among other public buildings in a certain town",
    convention: "chapter-based roman numerals with verified Chapter I override",
    likelySectionCount: 53,
    strategyNote:
      "the 53 numbered chapters beginning with CHAPTER I; exclude title page and Gutenberg wrapper",
    examples: [
  ...
  "the-benson-murder-case": {
    label: "CHAPTER I: Philo Vance at Home",
    startPhrase: "It happened that, on the morning",
    convention: "chapter-based roman numerals with verified Chapter I override",
    likelySectionCount: 25,
    strategyNote:
      "the 25 contents-listed chapters beginning with CHAPTER I; exclude contents, illustrator/source metadata, and Gutenberg wrapper",
    examples: ["CHAPTER I. Philo Vance at Home", "CHAPTER II. At the Scene of the Crime"],
  },
  "murder-in-the-maze": {
    label: "CHAPTER I: The Hackleton Case",
    startPhrase: "Neville Shandon stood at the window",
    convention: "chapter-based roman numerals with verified Chapter I override",
    likelySectionCount: 18,
    strategyNote:
      "the 18 contents-listed chapters beginning with CHAPTER I; exclude contents and Gutenberg wrapper",
    examples: ["CHAPTER I. The Hackleton Case", "CHAPTER II. The Affair in the Maze"],
  },
  "the-house-of-arden-a-story-for-children": {
    label: "CHAPTER I: ARDEN'S LORD",
    startPhrase: "It had been a great house once",
    convention: "chapter-based roman numerals with verified Chapter I override",
    likelySectionCount: 14,
    strategyNote:
      "the 14 chapter headings beginning with CHAPTER I; exclude illustrated title/contents material and Gutenberg wrapper",
    examples: ["CHAPTER I: ARDEN'S LORD", "CHAPTER II: THE MOULDIWARP"],
  },
  "the-thing-on-the-door-step": {
    label: "1",
    startPhrase: "It is true that I have sent six bullets",
    convention: "standalone arabic-numbered sections with verified section 1 override",
    likelySectionCount: 7,
    strategyNote:
      "the 7 numbered story sections beginning with section 1; exclude title/byline/publication/source wrapper",
    examples: ["1", "2", "3"],
  },
  "the-shadow-over-innsmouth": {
    label: "I",
    startPhrase: "During the winter of 1927-28 Federal government officials",
    convention: "standalone roman numeral sections with verified section I override",
    likelySectionCount: 5,
    strategyNote:
      "the 5 roman numeral story sections beginning with I; exclude title/byline/publication/source wrapper",
    examples: ["I", "II", "III"],
  },
  "at-the-mountains-of-madness": {
    label: "I.",
    ...
    convention: "standalone roman numeral sections with verified section I override",
    likelySectionCount: 12,
    strategyNote:
      "the 12 roman numeral story sections beginning with I; exclude title/byline/publication/source wrapper",
    examples: ["I.", "II.", "III."],
  },
  "the-remarkable-case-of-davidson-s-eyes": {
    label: "I.",
    startPhrase: "What's the matter with you?",
    convention: "standalone roman numeral sections with verified section I override",
    likelySectionCount: 5,
    strategyNote:
      "the 5 roman numeral story sections beginning with I; exclude parent collection title/source wrapper",
    examples: ["I.", "II.", "III."],
  },
  "two-in-a-sack": {
    label: "TWO IN A SACK",
    startPhrase: "What a life that poor man led with his wife",
    convention: "single fairy-tale story after parent collection wrapper",
    likelySectionCount: 1,
    strategyNote:
      "one contiguous fairy-tale story beginning at TWO IN A SACK; exclude parent Violet Fairy Book title/byline/source wrapper",
    examples: ["TWO IN A SACK"],
  },
};
...
function buildReport() {
  ...
  const allowedBranches = new Set([
    "main",
    "morsewords-book-processing-pilot-dry-run-10-jun-2026",
  ]);
  if (!allowedBranches.has(branch)) {
    throw new Error(`Expected dry-run 10 validation branch, got ${branch}`);
  }
  ...
  console.log(`Pilot dry-run 10 selected: ${report.selectedCount}`);
  console.log(
