import type { Route } from "./+types/how-to-type-in-morse-code";
...
const CONTENT = GUIDE_PAGES["how-to-type-in-morse-code"];
...
export default function HowToTypeInMorseCodeRoute() {
