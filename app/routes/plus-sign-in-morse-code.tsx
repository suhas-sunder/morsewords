import type { Route } from "./+types/plus-sign-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["plus-sign-in-morse-code"];
...
export default function PlusSignInMorseCodeRoute() {
