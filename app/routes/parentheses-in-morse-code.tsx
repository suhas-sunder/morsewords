import type { Route } from "./+types/parentheses-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["parentheses-in-morse-code"];
...
export default function ParenthesesInMorseCodeRoute() {
