import type { Route } from "./+types/quotation-mark-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["quotation-mark-in-morse-code"];
...
export default function QuotationMarkInMorseCodeRoute() {
