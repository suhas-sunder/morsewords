...
export function links() {
  return [
    {
      rel: "canonical",
      href: "https://morsewords.com/blog/wordskull-vs-absurdle-outwitting-the-adversarial-puzzle",
    },
  ];
}
...
export const meta = () => {
  const canonical =
    "https://morsewords.com/blog/wordskull-vs-absurdle-outwitting-the-adversarial-puzzle";
...
export default function Blog_WordSkullVsAbsurdle() {
    ...
    "@graph": [
        ...
        itemListElement: [
          {
            ...
            position: 1,
            name: "Home",
            item: "https://morsewords.com",
          },
          {
            "@type": "ListItem",
            position: 2,
            name: "Blog",
            item: "https://morsewords.com/blog",
          },
          {
            "@type": "ListItem",
            position: 3,
      ...
      },
      {
        ...
        publisher: {
          ...
          logo: {
            "@type": "ImageObject",
            url: "https://morsewords.com/og/wordskull-logo-512.jpg",
            width: 512,
            height: 512,
          },
        },
  ...
  return (
    <div
      ...
      } mw-non-home-page mw-legacy-content min-h-screen`}
    >
      {/* === Structured Data === */}
      <script
