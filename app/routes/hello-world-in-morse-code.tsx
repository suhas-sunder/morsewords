import type { Route } from "./+types/hello-world-in-morse-code";
...
const CONTENT = PHRASE_PAGES["hello-world-in-morse-code"];
...
export default function HelloWorldInMorseCodeRoute() {
