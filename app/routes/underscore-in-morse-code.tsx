import type { Route } from "./+types/underscore-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["underscore-in-morse-code"];
...
export default function UnderscoreInMorseCodeRoute() {
