import type { Route } from "./+types/i-love-you-in-morse-code";
...
const CONTENT = PHRASE_PAGES["i-love-you-in-morse-code"];
...
export default function ILoveYouInMorseCodeRoute() {
