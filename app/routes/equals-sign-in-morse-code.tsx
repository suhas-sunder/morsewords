import type { Route } from "./+types/equals-sign-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["equals-sign-in-morse-code"];
...
export default function EqualsSignInMorseCodeRoute() {
