import type { Route } from "./+types/apostrophe-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["apostrophe-in-morse-code"];
...
export default function ApostropheInMorseCodeRoute() {
