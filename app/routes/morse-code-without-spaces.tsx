import type { Route } from "./+types/morse-code-without-spaces";
...
const CONTENT = GUIDE_PAGES["morse-code-without-spaces"];
...
export default function MorseCodeWithoutSpacesRoute() {
