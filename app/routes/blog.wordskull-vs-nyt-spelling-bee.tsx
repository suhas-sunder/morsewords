...
export function links() {
  return [
    {
      rel: "canonical",
      href: "https://morsewords.com/blog/wordskull-vs-nyt-spelling-bee",
    },
  ];
}
...
export const meta = () => {
  const canonical =
    "https://morsewords.com/blog/wordskull-vs-nyt-spelling-bee";
  ...
  const ogImage =
    "https://morsewords.com/og/blog/wordskull-vs-nyt-spelling-bee.jpg";
