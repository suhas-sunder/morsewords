import type { Route } from "./+types/how-to-write-in-morse-code";
...
const CONTENT = GUIDE_PAGES["how-to-write-in-morse-code"];
...
export default function HowToWriteInMorseCodeRoute() {
