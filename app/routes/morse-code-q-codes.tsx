    ...
    <div style={styles.page}>
      <main style={styles.wrap}>
        <PageHero
          ...
          description="Q-codes are short three-letter signals used to compress radio and Morse messages. Many can be used as statements or questions depending on context."
          aside={
        ...
        <SectionCard
          eyebrow="Question or statement"
          title="How Q-codes change meaning"
          description="A Q-code can work as a question or a statement. Punctuation and context do the work."
        >
