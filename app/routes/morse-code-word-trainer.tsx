...
export function meta({}: Route.MetaArgs) {
  return seoMeta({
    ...
    description:
      "Practice Morse words with built-in or custom lists, audio playback, Farnsworth spacing, weak-word review, shareable results, and worksheet-ready review sets.",
    path: CANONICAL_PATH,
    keywords:
      "morse code word trainer, morse code words practice, custom morse word list, morse code word practice, morse word audio practice",
  });
}
...
export default function MorseCodeWordTrainer() {
  ...
  const answerIsCorrect =
    ...
    normalizedAnswer ===
      (mode === "morse_to_text"
        ? normalizeTextAnswer(expectedAnswer)
    ...
    <div style={styles.page}>
      <main style={styles.wrap}>
        <PageHero
          ...
          description="Practice Morse at the word level with a shuffled deck, audio playback, typed answers, weak-word review, and shareable results. Use a built-in list or paste your own words for classroom, radio, puzzle, or worksheet practice."
          aside={
            <DarkNote
                ...
                {listName === "custom" ? (
                  <label className="mt-5 block">
                    ...
                    <textarea
                      ...
                      className="mt-2 min-h-36 w-full rounded-xl border border-slate-200 bg-white p-4 font-mono text-sm outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
                      placeholder="SIGNAL, RADIO, PRACTICE"
                    />
                ...
                <div className="px-5 py-6">
                  ...
                  <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-slate-600">
                      {roundComplete
                        ? "Start a new round, shuffle the same list, or switch into weak-word review."
                        : mode === "morse_to_text"
                          ? "Type the plain word that matches the Morse prompt."
                          : "Type the Morse pattern using dots, dashes, and spaces."}
                    </p>
                  </div>
                  ...
                  <label className="mt-5 block">
                    ...
                    <input
                      ...
                      className="mt-2 min-h-12 w-full rounded-xl border border-slate-200 bg-white px-4 font-mono text-lg outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-100 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400"
                    />
                  </label>
            ...
            <aside className="space-y-5">
              ...
              <div className="rounded-2xl border border-slate-200 bg-[#fffdf8] p-5">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-slate-500">
                    {weakWords.length}
                  </span>
                </div>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {weakWords.map((word) => (
                        <button
                          ...
                          className="inline-flex min-h-10 cursor-pointer items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-3 py-2 font-mono text-sm font-bold text-slate-900 transition hover:border-sky-300 hover:bg-sky-50 focus:outline-none focus:ring-2 focus:ring-sky-300"
                        >
        ...
        <ToolHowItWorks
          ...
          description="The word trainer turns a list into a shuffled practice deck. Each prompt can be copied by sight, played as audio, answered in either direction, and sent into weak-word review when it needs more repetition."
        ...
        <SectionCard
          ...
          title="Use word practice after alphabet drills"
          description="Alphabet recall tells you whether you know each symbol. Word practice tells you whether you can recognize useful chunks quickly enough to read real messages."
        >
...
function MiniLink({
  ...
  return (
    <a
      href={href}
      className="cursor-pointer rounded-full border border-slate-200 bg-white px-3 py-1.5 text-sm font-semibold text-slate-700 transition hover:border-sky-300 hover:bg-sky-50 hover:text-sky-950 focus:outline-none focus:ring-2 focus:ring-sky-300"
    >
      {children}
    </a>
  );
