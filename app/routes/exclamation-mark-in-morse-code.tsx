import type { Route } from "./+types/exclamation-mark-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["exclamation-mark-in-morse-code"];
...
export default function ExclamationMarkInMorseCodeRoute() {
