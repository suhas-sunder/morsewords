import type { Route } from "./+types/ampersand-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["ampersand-in-morse-code"];
...
export default function AmpersandInMorseCodeRoute() {
