...
const CANONICAL_URL = "https://morsewords.com/lore";
...
export const meta = () => {
  ...
  const ogImage = "https://morsewords.com/og/lore/wordskull-lore.jpg";
      ...
      itemListElement:
        items.length === 0
          ...
          : items.map((p, i) => ({
              "@type": "ListItem",
              position: i + 1,
              url: `https://morsewords.com/lore/${p.slug}`,
              name: p.title,
            })),
    };
  });
...
export default function LoreIndex() {
  ...
  return (
    <div className="mw-non-home-page mw-legacy-content min-h-screen">
      <script
