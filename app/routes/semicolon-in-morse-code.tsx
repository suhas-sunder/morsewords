import type { Route } from "./+types/semicolon-in-morse-code";
...
const CONTENT = SYMBOL_PAGES["semicolon-in-morse-code"];
...
export default function SemicolonInMorseCodeRoute() {
