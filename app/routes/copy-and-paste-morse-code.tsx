import type { Route } from "./+types/copy-and-paste-morse-code";
...
const CONTENT = GUIDE_PAGES["copy-and-paste-morse-code"];
...
export default function CopyAndPasteMorseCodeRoute() {
