    ...
    <div style={styles.page}>
      <main style={styles.wrap}>
        <PageHero
          ...
          title="Morse code timing, WPM, and the PARIS standard"
          description="Morse timing is built from one unit: the dot. Dashes, gaps, words, and speed all come from that unit, which is why clean spacing matters when you translate, listen, practice, or print Morse."
          aside={
        ...
        <SectionCard
          ...
          description="International Morse timing uses fixed proportions. Speed changes the unit length, but the relationships stay the same."
        >
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
            {[
              ...
              <div
                key={name}
                className="grid gap-3 border-b border-slate-100 px-4 py-4 last:border-b-0 md:grid-cols-[180px_160px_1fr]"
              >
        ...
        <SectionCard
          eyebrow="Speed"
          title="Why PARIS is used for WPM"
          description="Morse speed is commonly measured with the standard word PARIS. It is treated as 50 timing units when the trailing word gap is included."
        >
