...
const CANONICAL_PATH = "/morse-code-printable-worksheets";
...
export function meta() {
  return seoMeta({
    title: "Printable Morse Code Worksheets | Custom Practice Sheets | MorseWords",
    description:
...
export default function MorseCodePrintableWorksheets() {
  ...
  React.useEffect(() => {
    setSettings(readInitialPrintableSettings());
  ...
  return (
    <div className="mw-non-home-page" style={styles.page}>
      ...
      <main className="mw-printable-chart-page" style={styles.wrap}>
        <PageHero
          eyebrow="Custom practice sheets"
          title="Printable Morse Code Worksheets"
          description="Build a study sheet or classroom handout with your own words and sentences, student and teacher fields, and optional answer keys. Print it or export a PDF or image."
          aside={
        ...
        >
          <ActionLinks
            links={[
              { href: "/morse-code-printable-chart", label: "Browse printable Morse code charts" },
