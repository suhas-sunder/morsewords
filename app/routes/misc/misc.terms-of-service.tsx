...
export const meta: Route.MetaFunction = () => {
  ...
  return [
    ...
    { property: "og:image:alt", content: "MorseWords terms of service" },
    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 pb-10 pt-2 text-slate-800 sm:pb-12 sm:pt-4">
      <header className="flex w-full flex-col gap-5 px-1 py-3 sm:px-2">
        ...
        <p className="flex flex-col gap-4 py-2">
          We are MorseWords (https://www.morsewords.com) ("Company", "we", "us",
          "our").
        </p>

        <p>
          We operate the website https://www.morsewords.com (the "Site"), as
        ...
        <p>
          ...
          MorseWords, concerning your access to and use of the Services. You
      ...
      <main className="flex max-w-5xl flex-col gap-8 rounded-2xl bg-[#fffdf8]/75 p-5 leading-relaxed sm:p-8">
        <section className="flex flex-col gap-4">
          ...
          <p>
            The Services provide content and tools related to Morse code and
            related learning and entertainment features. The information
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            reside (or, if you are, you have the involvement and consent of a
            parent or legal guardian); (5) you will not access the Services
            through automated or non-human means, whether through a bot, script
            or otherwise; (6) you will not use the Services for any illegal or
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            the future). You agree to keep your password confidential and will
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            The Services may include links to third-party products, affiliate
            offers, or merchandise in the future. Any third-party purchase is
            governed by that third party’s policies and terms.
          </p>
        </section>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            through third-party payment processors (for example, Stripe). The
          ...
          <p>
            ...
            including email address and payment method details, so that we can
            complete your transactions and contact you as needed. Sales tax may
            be added where required. We may change prices at any time. Currency
            will be disclosed at checkout.
          </p>
          <p>
            You agree to pay all charges at the prices then in effect for your
            purchases and any applicable fees, and you authorize us (or our
            payment processor) to charge your chosen payment provider for any
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            certain areas of the Services, such as sidebar advertisements or
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            providers. If you access the Services from any other region of the
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            ...
            "Notification"). A copy of your Notification may be sent to the
        ...
        <section className="flex flex-col gap-4">
          ...
          <p>
            Unless required by applicable law, you and we agree that any dispute
            arising out of or in connection with these Legal Terms will be
            resolved in the courts located in Ontario, Canada, and both Parties
          ...
          <p>
            ...
            law, (a) no Dispute shall be joined with any other proceeding; (b)
            there is no right or authority for any Dispute to be brought on a
