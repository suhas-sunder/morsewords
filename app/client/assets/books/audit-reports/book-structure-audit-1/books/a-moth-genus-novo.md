...
| --- | ---: | ---: | ---: | --- | --- |
| all-caps-title | 9 | 5 | 4 | yes |  |
| isolated-title-case | 6 | 5 | 1 | no | not selected because another strategy better spans the readable body |
...
- Sections: 5
- Min/median/max words: 3/20/4012
