# Pilot Book Processing Dry Run 21

Generated: 2026-06-21T00:09:29.922Z
...
Dry-run 21 intentionally uses `scripts/books/pilot-book-processing-dry-run-13.ts` as the shared implementation engine. The batch-21 entry point only sets `MORSEWORDS_PILOT_DRY_RUN_BATCH=21` and imports that engine; batch 13 remains the default when the environment flag is absent. The shared-file diff is therefore required dry-run-21 implementation, not an unrelated modification.
- Classification: required scoped fix implemented in the shared helper
- Resolution: Retain the shared-helper fix: exact individual title and first-prose evidence permits collection-extracted one-story sources to bypass only a TOC/body false-positive, while fallback and huge-section red flags remain hard failures; batch 13 stays the default.
...
- Manual review: 0
- Blocked: 0
- Skipped/unsafe raw-only candidates: 76
- Accepted/corrected/verified exclusion count: 405
...
| --- | --- | --- | --- | --- | --- | ---: | --- |
| a-deal-in-ostriches | individual story | A Deal in Ostriches | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| a-moonlight-fable | individual story | A Moonlight Fable | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| a-moth-genus-novo | individual story | A Moth--Genus Novo | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| aepyornis-island | individual story | Aepyornis Island | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| in-the-avu-observatory | individual story | In the Avu Observatory | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-cone | individual story | The Cone | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-country-of-the-blind | individual story | The Country of the Blind | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-crystal-egg | individual story | The Crystal Egg | Herbert George Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-diamond-maker | individual story | The Diamond Maker | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-flowering-of-the-strange-orchid | individual story | The Flowering of the Strange Orchid | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-flying-man | individual story | The Flying Man | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-hammerpond-park-burglary | individual story | The Hammerpond Park Burglary | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-lord-of-the-dynamos | individual story | The Lord of the Dynamos | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-star | individual story | The Star | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-stolen-bacillus | individual story | The Stolen Bacillus | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-stolen-body | individual story | The Stolen Body | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-temptation-of-harringay | individual story | The Temptation of Harringay | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-treasure-in-the-forest | individual story | The Treasure in the Forest | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| the-triumphs-of-a-taxidermist | individual story | The Triumphs of a Taxidermist | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
| through-a-window | individual story | Through a Window | H. G. Wells | author as identified by the source | single contiguous story section | 1 | needs first-time controlled processing |
...
76 remaining skipped/unsafe raw-only candidates are retained for a final remaining inventory/triage pass after safe batching slows or is exhausted; none are lost or silently accepted.
