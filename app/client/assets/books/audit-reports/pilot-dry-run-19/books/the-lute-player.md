# Pilot Dry Run 19: the-lute-player

- Candidate type: raw-only
- Source file used: `app/client/assets/temp-books/THE LUTE PLAYER.txt`
- Source folder: `app/client/assets/temp-books`
- Public/restricted status: review-only raw source; no generated publish/restricted status exists yet
- Expected title: The Lute Player
- Title evidence: source body heading line 52 - THE LUTE PLAYER
