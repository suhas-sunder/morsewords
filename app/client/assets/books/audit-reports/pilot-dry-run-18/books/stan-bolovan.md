# Pilot Dry Run 18: stan-bolovan

- Candidate type: raw-only
- Source file used: `app/client/assets/temp-books/STAN BOLOVAN.txt`
- Source folder: `app/client/assets/temp-books`
- Public/restricted status: review-only raw source; no generated publish/restricted status exists yet
- Expected title: Stan Bolovan
- Title evidence: source body heading line 52 - STAN BOLOVAN
...
- Expected first default section: Stan Bolovan
