# Pilot Dry Run 20: the-new-accelerator

- Candidate type: raw-only
- Source file used: `app/client/assets/temp-books/THE NEW ACCELERATOR.txt`
- Source folder: `app/client/assets/temp-books`
- Public/restricted status: review-only raw source; no generated publish/restricted status exists yet
- Expected title: The New Accelerator
- Title evidence: source body heading line 34 - THE NEW ACCELERATOR
