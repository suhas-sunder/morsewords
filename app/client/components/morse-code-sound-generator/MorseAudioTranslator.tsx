    ...
    <div style={styles.page}>
      ...
      <section className="pb-7">
            <div className="mw-tool-section mt-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-5">
                ...
                <button
                  ...
                  className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg px-3 py-2 font-semibold transition focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2 active:scale-95 ${player.isSupported && player.state !== "idle" ? "bg-[#fffdf8] text-slate-700 shadow-[0_7px_18px_rgba(11,36,71,0.07)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] hover:text-sky-950" : "cursor-not-allowed bg-[#fffaf2] text-slate-400"}`}
                >
                ...
                <button
                  ...
                  className={`flex cursor-pointer items-center justify-center gap-2 rounded-lg px-3 py-2 font-semibold transition focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2 active:scale-95 ${canPlay && soundOn ? "bg-[#fffdf8] text-slate-700 shadow-[0_7px_18px_rgba(11,36,71,0.07)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] hover:text-sky-950" : "cursor-not-allowed bg-[#fffaf2] text-slate-400"}`}
                >
            ...
            <div className="mt-4 rounded-xl bg-[#fffaf2]/45 p-4">
                ...
                <div className="mt-4 pt-4">
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select value={preset} onChange={(e) => setPreset(e.target.value as SoundPreset)} className="mt-2 w-full cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-2 font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.08)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] focus:outline-none focus:ring-2 focus:ring-sky-300">
              ...
              <div className="mt-4">
                  <button onClick={() => setAdvancedOpen((v) => !v)} className="inline-flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg bg-[#fffdf8] px-3 py-2 font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2 active:scale-95 sm:w-auto">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <select value={sampleRate} onChange={(e) => setSampleRate(validateSampleRate(Number(e.target.value)))} className="mt-2 w-full cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-2 font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.08)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] focus:outline-none focus:ring-2 focus:ring-sky-300">
                    ...
                    <div className="mt-4 rounded-2xl bg-[#fffdf8] p-4">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <select id={`${safePrefix}_mp3_kbps`} value={mp3Kbps} onChange={(e) => setMp3Kbps(Number(e.target.value))} className="cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-2 font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.08)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] focus:outline-none focus:ring-2 focus:ring-sky-300">
...
function InputButtons({ onUseExample, onUseSecond, secondLabel, onClear }: { onUseExample: () => void; onUseSecond?: () => void; secondLabel?: string; onClear: () => void }) {
  return (
    <div className="mt-2 flex flex-wrap items-center gap-2">
      <button type="button" onClick={onUseExample} className="cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-1.5 text-sm font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] active:scale-95">Use example</button>
      {onUseSecond && secondLabel ? <button type="button" onClick={onUseSecond} className="cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-1.5 text-sm font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] active:scale-95">{secondLabel}</button> : null}
      <button type="button" onClick={onClear} className="ml-auto cursor-pointer rounded-xl bg-[#fffdf8] px-3 py-1.5 text-sm font-semibold shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] active:scale-95">Clear input</button>
    </div>
  );
}
...
function ExportButton({ label, onClick, disabled }: { label: string; onClick: () => void; disabled: boolean }) {
  return (
    <button type="button" onClick={onClick} disabled={disabled} className={`inline-flex cursor-pointer items-center gap-2 rounded-lg px-3 py-2 font-semibold transition focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2 active:scale-95 ${!disabled ? "bg-[#fffdf8] text-slate-700 shadow-[0_7px_18px_rgba(11,36,71,0.07)] hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] hover:text-sky-950" : "cursor-not-allowed text-slate-400"}`}>
