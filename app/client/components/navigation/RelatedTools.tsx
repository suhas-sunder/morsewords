  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        description:
          "Browse reviewed book pages from approved public-domain sources.",
      ...
      },
      {
        ...
        description:
          "Open approved books with browser-generated Morse audio and MP3/WAV controls.",
...
const COMPACT_TOOLKIT_PATHS = new Set<string>([
  ROUTES.nameToMorse,
  ROUTES.numbers,
  ROUTES.howToRead,
  ROUTES.howToWrite,
