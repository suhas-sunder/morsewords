...
import spotify_webp from "../../assets/images/spotify_icon.webp";
...
function SocialLinks() {
 ...
 url:"https://ca.pinterest.com/Morsewords",
 ...
 name:"Reddit",
 label:"Community",
 url:"https://www.reddit.com/r/morsewordsapp",
 pngImg: reddit_png,
 webpImg: reddit_webp,
 },
 {
 ...
 name:"YouTube",
 label:"Videos",
 url:"https://www.youtube.com/@morsecodewords",
 pngImg: youtube_png,
 ...
 target="_blank" rel="nofollow noreferrer noopener" aria-label={link.ariaLabel ?? `Open MorseWords on ${link.name}`}
 >
...
function SocialIcon({ link }: { link: SocialLink }) {
 ...
 const fallbackImg = pngImg ?? webpImg;
 ...
 {webpImg ? <source srcSet={webpImg} type="image/webp"/> : null}
 {pngImg ? <source srcSet={pngImg} type="image/png"/> : null}
 <img
 src={fallbackImg}
