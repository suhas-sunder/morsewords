    ...
    <section className="mt-8 bg-white border border-gray-200 rounded-2xl p-5 sm:p-8 shadow-sm">
      <div className="flex flex-col gap-3">
        ...
        <p className="text-base sm:text-lg text-gray-700 leading-relaxed">
          This page is a focused{" "}
          <strong>Morse code decoder</strong>. It converts <strong>International Morse</strong> (dots and dashes) back into readable text, emphasizing spacing and separators. It is built to be predictable:
