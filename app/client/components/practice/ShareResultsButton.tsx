          ...
          <div className="w-full max-w-3xl overflow-hidden rounded-xl bg-[#fffdf8] shadow-[0_7px_18px_rgba(11,36,71,0.07)]">
            ...
            <div className="p-4 sm:p-5">
              <div className="flex flex-wrap items-center gap-3">
                ...
                {pngBlob ? (
                  <a
                    className="inline-flex cursor-pointer items-center gap-2 rounded-lg bg-[#fffdf8] px-4 py-2 text-sm font-semibold text-slate-900 shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition hover:bg-white focus:outline-none focus:ring-2 focus:ring-sky-300 focus:ring-offset-2"
