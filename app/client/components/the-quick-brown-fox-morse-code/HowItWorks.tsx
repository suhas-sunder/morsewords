...
export default function HowItWorks() {
 ...
 <div
 id="phrase" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 ...
 <div
 id="morse-copy" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 ...
 <div
 id="morse-slash" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 ...
 <div
 id="decode-check" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 Decode check
 </h3>
 ...
 <div
 id="spacing-rules" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 Spacing rules
 </h3>
 ...
 <div
 id="tips" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 ...
 <div
 id="related-tools" className="rounded-xl bg-[#fffdf8] p-6 sm:p-7">
 <h3 className="text-xl sm:text-2xl font-extrabold text-sky-950">
 Related tools
 </h3>
