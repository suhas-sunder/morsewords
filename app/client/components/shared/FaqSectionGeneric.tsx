      ...
      >
        ...
        <div className="mt-7 space-y-3">
          {items.map((it) => (
            <details
              key={it.q}
              className="group rounded-xl bg-[#fffaf2] px-4 shadow-[0_7px_18px_rgba(11,36,71,0.07)] transition-[background-color,box-shadow] open:bg-white hover:bg-white hover:shadow-[0_10px_24px_rgba(11,36,71,0.12)] sm:px-5"
            >
