        ...
        <table className="min-w-[720px] w-full border-collapse">
          <thead>
            <tr className="text-left bg-gray-50">
              <th className="p-3 border border-gray-200">Character</th>
              <th className="p-3 border border-gray-200">Morse</th>
              <th className="p-3 border border-gray-200">Category</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r) => (
              <tr key={`${r.category}-${r.symbol}`} className="hover:bg-gray-50">
                <td className="p-3 border border-gray-200 font-semibold">{r.symbol}</td>
                <td className="p-3 border border-gray-200 font-mono">{r.morse}</td>
                <td className="p-3 border border-gray-200">{r.category}</td>
              </tr>
            ))}
          </tbody>
        </table>
